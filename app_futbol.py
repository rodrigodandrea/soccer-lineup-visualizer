...
COORDS = {
    ...
    'MEDIO_CENTRO_DEFENSIVO': (40, 40),  'VOLANTE_OFENSIVO_DERECHO': (55, 52), 'VOLANTE_OFENSIVO_IZQUIERO': (55, 28), 
    'VOLANTE_LATERAL_DERECHO': (55, 70), 'VOLANTE_LATERAL_IZQUIERDO': (55, 10),
...
FORMATIONS = {
    "4-4-2": ['ARQUERO', 
              ...
              'VOLANTE_LATERAL_DERECHO', 'VOLANTE_OFENSIVO_DERECHO', 'VOLANTE_OFENSIVO_IZQUIERO', 'VOLANTE_LATERAL_IZQUIERDO', 
              'DELANTERO_DERECHO', 'DELANTERO_IZQUIERDO'],
    "3-5-2": ['ARQUERO', 
              'DEFENSOR_DERECHO_CENTRAL', 'DEFENSOR_IZQUIERDO_CENTRAL', 'DEFENSOR_CENTRAL',
              'VOLANTE_LATERAL_DERECHO', 'VOLANTE_OFENSIVO_DERECHO', 'MEDIO_CENTRO_DEFENSIVO', 'VOLANTE_OFENSIVO_IZQUIERO', 'VOLANTE_LATERAL_IZQUIERDO', 
              'DELANTERO_DERECHO', 'DELANTERO_IZQUIERDO'],
    "4-1-2-2-1": ['ARQUERO', 
              'LATERAL_DERECHO', 'CENTRAL_DERECHO', 'CENTRAL_IZQUIERDO', 'LATERAL_IZQUIERDO', 
              'VOLANTE_OFENSIVO_DERECHO', 'MEDIO_CENTRO_DEFENSIVO', 'VOLANTE_OFENSIVO_IZQUIERO',
